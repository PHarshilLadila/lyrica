...
class _ProfileScreenState extends ConsumerState<ProfileScreen>
  ...
  Future<void> _saveProfileChanges(UserModel user) async {
    ...
    try {
      final firestoreSuccess = await ref
      ...
      child: Scaffold(
        ...
        body: userModelAsync.when(
          data: (userModel) {
            ...
            final profileImage =
                userModel.image.isNotEmpty ? userModel.image : AppImages.avatar;
                      ...
                      AnimatedOpacity(
                        ...
                        child: Column(
                          children: [
                            AppText(
                              text:
                                  "${AppLocalizations.of(context)!.hey}, ${userModel.username} 👋",
                              fontSize: 22.sp,
                              fontWeight: FontWeight.bold,
                              textColor: Colors.white,
                            ),
